  ...
  <div class="signin">
    <van-form ref="form">
      <div class="from-item" v-if="show">
        ...
        <van-field class="input-border" v-model="form.otype" :placeholder="$t('content.select_network')"
          :disabled="true" />
      </div>
      <div class="from-item" v-if="show">
        <p>{{ $t("content.wallet_address") }}</p>
        <van-field class="input-border" v-model="form.walletAddress" :placeholder="$t('content.wallet_address')"
          :disabled="true" />
      </div>
      <div class="from-item">
        <p>{{ $t("content.email") }}</p>
        <van-field class="input-border" v-model="form.mail" :placeholder="$t('content.email')" :rules="[
      ...
      <div class="from-item">
        <p>{{ $t("content.pwd") }}</p>
        <van-field class="input-border" v-model="form.password" type="password" :placeholder="$t('content.pwd')"
