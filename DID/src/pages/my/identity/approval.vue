      ...
      >
        <ul class="list">
          <li class="item"
            ...
            :key="item.id"
          >
            <img class="status" v-if="tab.active === 1" :src="require('../../../assets/imgs/status_confirm.png')" alt="">
            <img class="status" v-if="tab.active === 2" :src="require('../../../assets/imgs/status_cancel.png')" alt="">
...
import {approval, list} from "@/api/pagesApi/identity";
