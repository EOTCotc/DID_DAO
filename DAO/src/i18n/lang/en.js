module.exports = {
  ...
  becomeAnArbitrator: {
    ...
    idcardmessage: 'You have not been authenticated. Please go to DID for identity authentication',
    pledgetitle: 'pledge',
    pledgemessage: 'Pledge does not meet the conditions, please go to the OTC exchange for pledge',
    approved: 'application approved',
    approvedmsg: "After becoming an arbitrator, the platform will assign you an arbitration case",
    _approvedmsg: "When you become an audit node, the platform assigns you an audit",
    approvedbText2: "alright",
    relievetitle3: "warm prompt",
    relievemsg: "The platform will not be assigned to handle arbitration cases after the removal of the identity, and the application for the identity of arbitrator needs to be re-studied and tested",
    _relievemsg: "After removing the identity, the platform will not assign any audit, and the application for the identity of the audit node needs to be studied and tested again",
    think: "Let me think",
  ...
  exam: {
    ...
    timeoverMsg: "Unfortunately, the examination time has come to an end. Please take the examination again",
    ...
    testQuestionData: [
      {
        id: 1,
        question: 'Topic 1',
        questionContant: 'Transaction, the buyer makes a note transaction relevant information will be judged?',
      ...
      },
      {
        id: 2,
        question: 'Topic 2',
        questionContant: 'Based on the credit score, how many hours after the default payment is released?',
        topicType: '(single choice)',
        result: '',
        questionAnswer: [
          {
      ...
      },
      {
        id: 3,
        question: 'Topic 3',
        questionContant: 'Within what period can a seller initiate a black money arbitration?',
        topicType: '(single choice)',
        result: '',
        questionAnswer: [
          {
      ...
      },
      {
        id: 5,
        question: 'Topic 5',
        questionContant: 'Which of the following is valid evidence in arbitration?',
        topicType: '(multiple choice)',
        result: [],
        questionAnswer: [
          {
      ...
      },
      {
        id: 6,
        question: 'Topic 6',
        questionContant: 'Based on the credit score, the system defaults to 12-24 hours after the payment is received?',
      ...
      },
      {
        id: 7,
        question: 'Topic 7',
        questionContant: 'Do you need to use the same name account of DID to make money?',
        topicType: '(Judgmental question)',
        result: '',
        questionAnswer: [
          {
      ...
      },
      {
        id: 8,
        question: 'Topic 8',
        questionContant: 'Arbitration DAO does not support arbitration for out-of-name payment?',
        topicType: '(Judgmental question)',
        result: '',
        questionAnswer: [
          {
      ...
      },
      {
        id: 9,
        question: 'Topic 9',
        questionContant: ['Timeout put COINS', 'There is no need for arbitration, and the system automatically deducts points.'],
      ...
      },
      {
        id: 10,
        question: 'Topic 10',
        questionContant: ['After the system automatically deducts the points, the overtime is more than 60 minutes can apply'],
        topicType: '(Completion)',
        result: '',
      ...
      },
      {
        id: 11,
        question: 'Topic 11',
        questionContant: ["The loss caused by the seller's early release of coins in a transaction", 'undertake'],
        topicType: '(Completion)',
        result: '',
        Answers: 'voluntarily',
      },
      {
        id: 12,
        question: 'Topic 12',
        questionContant: ['Buyer to apply for paid arbitration, need to provide with', 'The payment voucher'],
        topicType: '(Completion)',
        result: '',
  ...
  Detailsofproposal: {
    ...
    ticket: "ticket",
    introduce1: "The proposal needs 99 votes to progress, and the author can terminate at any time",
    introduce2: "The proposal has been voted on by 99 people and the vote is complete",
    ...
    votemessage: "Please select the type you want to vote for, and the current account must have 100 EOTC",
    know: "got it"
  },
  pending: {
  ...
  cApproval: {
    ...
    Approvalmesg: "Please make sure that the information is correct and the application is approved?",
  ...
  Teammember: {
    ...
    statusdata: ['Unapproved', 'Approved', 'No real name authentication', 'other']
  },
  arbitrationcase: {
    ...
    title1: "Application for extension",
    title2: "Additional evidence",
    title3: "Initiate new proof",
    title4: "Cancel arbitration",
    title5: "Notice of Closure",
    suss: "Submitted successfully",
    year: "year",
    month: "month",
    d: "day",
    Tl: "Arbitration case",
    ...
    accused: "defendant",
    buyer: "(Buyer)",
    arbitrateInType1: "Account frozen",
    arbitrateInType2: "The seller did not confirm the collection",
    arbitrateInType3: "other",
    detail: "Details of arbitration",
    result: "Arbitration result",
    headcount: "The total number of arbitrators involved in the arbitration event",
    defendantNum: "People, through proof submitted by both parties,",
    dsads: "Arbitrators awarded the defendant dsads",
    particulars: "details",
    applicant: "applicant",
    _accuser: "plaintiff:",
    PR: "Reason for application",
    ...
    Proof1: "The plaintiff adduced evidence",
    Proof2: "The defendant adduces evidence",
    Proof3: "Additional evidence",
    initiator: "Sponsor",
    number: "number: ",
    reason: "Reason for application",
    illustrate: "explain",
    res: "The arbitration case has been settled. If you have any objection, you can enter the details and apply for re arbitration within seven days after the settlement of the case. Please note that you will not be able to re arbitrate the case within the time limit",
    Toprooftl: "Initiate new proof",
    Toproofterm: "One of the following conditions shall be met for initiating new evidence",
