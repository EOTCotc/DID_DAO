<template>
  <van-pull-refresh v-model="list.uploading"
        ...
        <ul class="list">
          <li class="item"
            ...
            <van-row class="item-row">
              <van-col span="8"
                       class="name">{{$t('Autionaudit.phoneNum')}}</van-col>
              <van-col span="16"
                       class="value">{{item.phoneNum}}</van-col>
            </van-row>
            <van-row class="item-row">
              <van-col span="8"
                       class="name">{{$t('Autionaudit.idCard')}}</van-col>
              <van-col span="16"
                       class="value">{{item.idCard}}</van-col>
            </van-row>
            <van-row class="item-row">
              <van-col span="24"
                       class="name">{{$t('Autionaudit.portraitImage')}}</van-col>
              <van-col span="24"
                       class="value">
                <div class="imgs">
                  <img class="img"
    ...
    <!--  图片预览  -->
    <van-image-preview v-model="imgPreview.show"
